//
// arduino_simon_says.ino
// Description: Memory game played by pressing one of four buttons.
...
void setup() {
  ...
  if (checkButton() == CHOICE_GREEN) {
    ...
    set_leds(CHOICE_RED | CHOICE_BLUE | CHOICE_YELLOW);
...
void play_beegees() {
  ...
  set_leds(CHOICE_RED | CHOICE_GREEN | CHOICE_BLUE);

  while(checkButton() != CHOICE_NONE) ;

  set_leds(CHOICE_NONE);
  delay(1000);
  digitalWrite(BUZZER1, LOW);
